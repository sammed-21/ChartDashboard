...
//           <h1 className="font-bold text-2xl  max-sm:hidden">Dashboard</h1>
//           <div className="flex gap-2 w-full justify-end items-end max-sm:items-center">
//             <div
             
//               className="max-sm:w-[6rem] relative text-gray-400 focus-within:text-gray-600 block"
//             >
//               <Image
//                 src={searchIcon}
//                 width={15}
...
//                 name="search"
//                 placeholder="Search..."
//                 className=" py-2 px-5 w-full max-sm:px-2 rounded-full"
//               />
//             </div>
